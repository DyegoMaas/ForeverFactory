...
{
    public class NavigationBetweenInterfaces2Tests
    {
        private readonly PersonFactory2 _factory;

        public NavigationBetweenInterfaces2Tests()
        {
            _factory = new PersonFactory2();
        }
